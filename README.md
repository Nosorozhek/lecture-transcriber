...
Датасета для данной задачи я не нашел, хотя казалось бы, не такая уж и специфичная задача как будто, поэтому пришлось написать отдельный ноутбук для создания датасета примеров для этой модели.
...
_Note: мне пока не удалось сделать красивый рендер слайдов в приложении и захостить на останавливаемом сервере, но я это обязательно сделаю, все-таки не зря я потратил чуть больше недели на это..._
